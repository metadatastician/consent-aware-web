...
image:https://api.scorecard.dev/projects/github.com/metadatastician/consent-aware-http/badge[OpenSSF Scorecard,link="https://scorecard.dev/viewer/?uri=github.com/metadatastician/consent-aware-http"]
image:https://sonarcloud.io/api/project_badges/measure?project=metadatastician_consent-aware-http&metric=alert_status[SonarQube Quality Gate,link="https://sonarcloud.io/summary/new_code?id=metadatastician_consent-aware-http"]
image:https://archive.softwareheritage.org/badge/origin/https://github.com/metadatastician/consent-aware-http/[Archived in Software Heritage,link="https://archive.softwareheritage.org/browse/origin/?origin_url=https://github.com/metadatastician/consent-aware-http"]
