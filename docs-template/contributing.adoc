...
= Contributing — Consent-Aware Web
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Consent-Aware Web`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Consent-Aware Web.git
...
* Bugs in `Consent-Aware Web`: file at `metadatastician/Consent-Aware Web/issues`.
