...
// SPDX-FileCopyrightText: 2026 Jonathan D.A. Jewell (metadatastician) <jonathan@metadatastician.art>
= Contributing — Consent-Aware HTTP
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Consent-Aware HTTP`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Consent-Aware HTTP.git
...
* Bugs in `Consent-Aware HTTP`: file at `metadatastician/Consent-Aware HTTP/issues`.
