...
doctor:
    @echo "Running diagnostics for consent-aware-http..."
...
help-me:
    @echo "=== consent-aware-http Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/consent-aware-http/issues/new"
    @echo ""
