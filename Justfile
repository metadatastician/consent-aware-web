...
project := "consent-aware-web"
OWNER := "metadatastician"
REPO := "consent-aware-web"
version := "0.1.0"
...
doctor:
    @echo "Running diagnostics for consent-aware-web..."
...
help-me:
    @echo "=== consent-aware-web Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/consent-aware-web/issues/new"
    @echo ""
