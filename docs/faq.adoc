...
(As of July 2025, this is a new protocol. Early adopters will be listed at https://consent-aware-web.org/adopters[https://consent-aware-web.org/adopters])
...
* *GitHub Discussions*: https://github.com/Hyperpolymath/consent-aware-web/discussions
* *Issues*: https://github.com/Hyperpolymath/consent-aware-web/issues
