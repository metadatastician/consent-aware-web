...
* https://github.com/Hyperpolymath/consent-aware-web[draft-jewell-aibdp-00] - AIBDP specification
* https://github.com/Hyperpolymath/consent-aware-web[draft-jewell-http-430-consent-required-00] - HTTP 430 status code
