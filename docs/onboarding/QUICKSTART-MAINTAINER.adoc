...
// Replace consent-aware-http, UNASSIGNED, UNASSIGNED with actuals
= consent-aware-http — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining consent-aware-http for
...
podman build -t consent-aware-http .
----
...
* Upstream: https://github.com/metadatastician/consent-aware-http/issues
