...
// Replace consent-aware-http, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= consent-aware-http — Quick Start for Users
:toc:
:toclevels: 2
...
[source,bash]
----
just install --portable --prefix=./consent-aware-http-portable
----
...
* **Wiki**: https://github.com/metadatastician/consent-aware-http/wiki
