...
// Replace consent-aware-web, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= consent-aware-web — Quick Start for Users
:toc:
:toclevels: 2

== What is consent-aware-web?
...
[source,bash]
----
just install --portable --prefix=./consent-aware-web-portable
----
