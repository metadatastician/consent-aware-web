...
*Reversibility* is a core architectural principle: Every operation should be undoable. This document explains how reversibility is implemented in the Consent-Aware Web Standards project.
