...
Jonathan D.A. Jewell (metadatastician) <jonathan@metadatastician.art>
:toc:
:sectnums:
...
Use the template at TOPOLOGY.md in consent-aware-http as a structural reference,
...
[source,bash]
----
cp /path/to/consent-aware-http/TOPOLOGY.md ./TOPOLOGY.md
