...
Replace all {{PLACEHOLDER}} values:
  Consent-Aware Web     - Your project name
  metadatastician            - GitHub/GitLab username or org
  consent-aware-web             - Repository name
  jonathan@metadatastician.art    - Email for conduct reports
...
We as members, contributors, and leaders pledge to make participation in Consent-Aware Web a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
|--------|---------|----------|
| **Email** | jonathan@metadatastician.art | Detailed reports, sensitive matters |
...
2. **Email** jonathan@metadatastician.art with subject line "Appeal: [Original Report ID]"
...
- Open a [Discussion](https://github.com/metadatastician/consent-aware-web/discussions) (for general questions)
- Email jonathan@metadatastician.art (for private questions)
