...
Replace all {{PLACEHOLDER}} values:
  Consent-Aware HTTP     - Your project name
  metadatastician            - GitHub/GitLab username or org
  consent-aware-http             - Repository name
...
- Open a [Discussion](https://github.com/metadatastician/consent-aware-http/discussions) (for general questions)
